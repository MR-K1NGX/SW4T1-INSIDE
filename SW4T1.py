...
def svn_digit():
	...
	with ThreadPool(max_workers=70) as yaari:
		...
		print('\033[1;32m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
			pwx = [guru,kode+guru]
...
def ali_khan():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print('\0331;32m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
